...
export default function StudioPage() {
  ...
  async function handleAnalyze() {
    ...
    try {
      ...
      if (!data.success) {
        throw new Error(data.message || "Unable to analyze space");
      }
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
        <div className="rounded-2xl border bg-white p-8 text-center shadow-sm">
          <h1 className="text-xl font-bold">No product selected</h1>
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <header className="border-b bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div>
            <h1 className="text-2xl font-bold">VirtualShop AI</h1>
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-slate-600">
            Upload a photo of your room and see how your selected furniture
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_360px]">
          ...
          <div className="rounded-2xl border bg-white p-6 shadow-sm">
            <h3 className="text-lg font-bold">1. Upload your room</h3>

            <p className="mt-1 text-sm text-slate-500">
              Use a clear photo showing the area where you want to place the
              furniture.
            </p>
              ...
              {imagePreview ? (
                ...
                <label className="flex min-h-[420px] cursor-pointer flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 px-6 text-center transition hover:border-indigo-400 hover:bg-indigo-50">
                  ...
                  <p className="mt-2 max-w-md text-sm text-slate-500">
                    Drag and drop your image here, or click to browse your
                    device.
                  </p>
          ...
          <aside className="h-fit rounded-2xl border bg-white p-6 shadow-sm">
            <h3 className="text-lg font-bold">2. Selected product</h3>
            ...
            {analysis && (
              <div className="mt-6 rounded-2xl border bg-slate-50 p-5">
                <div className="flex items-center justify-between">
                  <h4 className="font-bold">AI Space Analysis</h4>
            ...
            {!imagePreview && (
              <p className="mt-3 text-center text-xs text-slate-400">
                Upload a room image to continue.
              </p>
            )}
          </aside>
        </div>
